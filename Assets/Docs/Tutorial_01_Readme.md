...
- 出生点由 `PlayerSpawnIntro2D` 播放约 10 秒可跳过电影感叙事片头：先黑屏显示 A-07 故障日志，再慢速扫过废弃维修站，最后回到维修台完成更完整的扫描光、维修臂轻摆、蒸汽、火花和主角苏醒。
...
- 出生区大型旧维修臂仍不进场；`SpawnIntro_RepairArm` 只作为开场短动画件使用，并由 `SpawnIntro_AwakeningPolish` 统一管理；开场新增黑屏日志和环境扫镜，随后维修台轻微震动并短闪蓝白电弧，避免长期压住玩家轮廓。
